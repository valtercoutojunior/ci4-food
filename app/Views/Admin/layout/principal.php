...
<head>
    ...
    <!-- Vendor CSS Files -->
    <link href="<?= site_url('admin/assets/vendor/bootstrap/css/bootstrap.min.css'); ?>" rel="stylesheet">
    <link href="<?= site_url('admin/assets/vendor/bootstrap-icons/bootstrap-icons.css'); ?>" rel="stylesheet">
    <link href="<?= site_url('admin/assets/vendor/boxicons/css/boxicons.min.css'); ?>" rel="stylesheet">
...
<body class="d-flex flex-column wrapper">
    ...
    <header id="header" class="header fixed-top d-flex align-items-center">
        ...
        <div class="d-flex align-items-center justify-content-between">
            <a href="index.html" class="logo d-flex align-items-center">
                <img src="<?= site_url('admin/assets/img/logo.png') ?>" alt="">
            ...
            <ul class="d-flex align-items-center">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow messages">
                        ...
                        <li class="message-item">
                            <a href="#">
                                <img src="<?= site_url('admin/assets/img/messages-1.jpg'); ?>" alt="" class="rounded-circle">
                                <div>
                                    <h4>Maria Hudson</h4>
                        ...
                        <li class="message-item">
                            <a href="#">
                                <img src="<?= site_url('admin/assets/img/messages-2.jpg') ?>" alt="" class="rounded-circle">
                                <div>
                                    <h4>Anna Nelson</h4>
                                    <p>Velit asperiores et ducimus soluta repudiandae labore officia est ut...</p>
                                    <p>6 hrs. ago</p>
                        ...
                        <li class="message-item">
                            <a href="#">
                                <img src="<?= site_url('admin/assets/img/messages-3.jpg') ?>" alt="" class="rounded-circle">
                                <div>
                                    <h4>David Muldon</h4>
                                    <p>Velit asperiores et ducimus soluta repudiandae labore officia est ut...</p>
                                    <p>8 hrs. ago</p>
                ...
                <li class="nav-item dropdown pe-3">
                    ...
                    <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
                        <img src="<?= site_url('admin/assets/img/profile-img.jpg') ?>" alt="Profile" class="rounded-circle">
    ...
    <script src="<?= site_url('admin/assets/js/main.js'); ?>"></script>
