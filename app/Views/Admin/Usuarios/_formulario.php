<div class="form-row">
    ...
    <div class="form-group col-md-3">
        ...
        <input type="text" class="form-control cpf" name="cpf" id="inputCpf" value="<?= $usuario->cpf; ?>">
    </div>
</div>
...
<div class="form-row">
    <div class="form-group col-md-4">
        ...
        <input type="email" class="form-control" name="email" id="inputEmail" value="<?= $usuario->email; ?>">
    </div>
...
<div class="form-row">
    ...
    <div class="form-group col-md-6">
        <label for="inputCofirmeSenha">CPF</label>
